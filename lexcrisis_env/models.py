...
class Reward(BaseModel):
    ...
    verifier_signals: Dict[str, float] = Field(
        default_factory=dict,
        description="Independent verifier columns for the last step.",
    )
    flags: List[str] = Field(
        default_factory=list,
        description="Safety or process flags raised on the last step.",
    )
