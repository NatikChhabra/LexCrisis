...
SCRIPTED_BASELINES: Dict[str, List[Dict[str, Any]]] = {
    "task_1": [
        ...
        {"action_type": "review_client", "parameters": {"client_id": "CLIENT-002"}},
        {"action_type": "review_client", "parameters": {"client_id": "CLIENT-003"}},
        {"action_type": "review_client", "parameters": {"client_id": "CLIENT-004"}},
        {"action_type": "review_client", "parameters": {"client_id": "CLIENT-005"}},
        {"action_type": "review_client", "parameters": {"client_id": "CLIENT-006"}},
        {
        ...
        {
            "action_type": "check_conflict",
            "parameters": {"client_a": "CLIENT-002", "client_b": "CLIENT-003"},
        },
        {
            "action_type": "cite_rule",
            "parameters": {
        ...
        {
            "action_type": "check_conflict",
            "parameters": {"client_a": "CLIENT-003", "client_b": "CLIENT-004"},
        },
        {
            "action_type": "cite_rule",
            "parameters": {
        ...
        {
            "action_type": "check_conflict",
            "parameters": {"client_a": "CLIENT-003", "client_b": "CLIENT-005"},
        },
        {
            "action_type": "cite_rule",
            "parameters": {
    ...
    "task_3": [
        ...
        },
        {
            "action_type": "file_motion",
            "parameters": {
                "motion_type": "forum_consolidation_transfer",
                "court": "National Coordination Bench",
                "arguments": "Coordinate related suits to reduce inconsistent rulings and preserve expert efficiency.",
            },
        },
